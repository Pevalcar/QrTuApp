...
export function SwitchDarkMod() {
  ...
  return (
    <div class="flex items-start justify-center">
      <button
        class="rounded-full border-0 bg-transparent px-4 py-2 text-2xl font-bold outline-none transition hover:bg-slate-200"
        onClick={handleDarkMode}
        aria-label="button-dark-mode"
      >
        {darkMode ? (
          <svg
            class="text-yellow-500 h-10 w-10 stroke-gray-500"
            width="40"
            height="40"
            viewBox="0 0 24 24"
            fill="none"
          ...
          <svg
            class="text-slate-600 h-10 w-10"
            width="40"
            height="40"
            viewBox="0 0 24 24"
            stroke-width="1.5"
